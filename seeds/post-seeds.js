...
const postData = [
    {
        ...
        post_content: "MVC allows developers to maintain a ture separation of concerns, devising their code between the model layer for data, the view layer of the design, and the controller layer for the application logic. ",
        user_id: 3
    },
    {
        title: "Authentication vs. Authorization!",
        post_content: "There is a diffrence between authentication and authorization. authentication means confirming your own identity, where as authorization means being allowed access to the system.",
        user_id: 1
    },
    {
    ...
    },
    {
        ...
        post_content: "I think a bootcamp is a faster route to start your career",
        user_id: 5
    },
    {
